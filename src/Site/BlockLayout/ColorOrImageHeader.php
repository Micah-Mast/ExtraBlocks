...
class ColorOrImageHeader extends AbstractBlockLayout
{
    ...
    {
        return 'Color or Image Header'; // @translate
    }
    ...
    public function form(
        ...
        $html .= '<div class="field-meta"><label>' . $view->translate('Text') . '</label></div>';
        $html .= '<div class="inputs"><textarea name="o:block[__blockIndex__][o:data][text]">' . $text . '</textarea></div>';
        $html .= '</div>';
        ...
        // Height
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Height (CSS value e.g. 40vh, 300px)') . '</label></div>';
        ...
        // Vertical position
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Image vertical position (e.g. 0% = top, 50% = center, 100% = bottom)') . '</label></div>';
        $html .= '<div class="inputs"><input type="text" name="o:block[__blockIndex__][o:data][vertical_position]" value="' . $verticalPosition . '"></div>';
        $html .= '</div>';

        // Overlay color
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Overlay color') . '</label></div>';
        $html .= '<div class="inputs"><input type="color" name="o:block[__blockIndex__][o:data][overlay_color]" value="' . $overlayColor . '"></div>';
        $html .= '</div>';

        // Overlay opacity
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Overlay opacity (0 = none, 1 = full)') . '</label></div>';
        ...
        // Overlay height
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Overlay Height (CSS value e.g. 40vh, 300px, 50%)') . '</label></div>';
        ...
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Previous element overlap (CSS value e.g. 50px, 0px to disable)') . '</label></div>';
        ...
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Next element overlap (CSS value e.g. 50px, 0px to disable)') . '</label></div>';
        $html .= '<div class="inputs"><input type="text" name="o:block[__blockIndex__][o:data][overlap_bottom]" value="' . $overlapBottom . '"></div>';
        $html .= '</div>';

        // Z-index
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Z-index (integer, default 0)') . '</label></div>';
        $html .= '<div class="inputs"><input type="number" name="o:block[__blockIndex__][o:data][z_index]" value="' . $zIndex . '"></div>';
        $html .= '</div>';

        // Asset picker
        $html .= '<div class="field">';
        $html .= '<div class="field-meta"><label>' . $view->translate('Banner Image') . '</label></div>';
